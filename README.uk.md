...
Швидкі посилання: [Встановлення](#install) | [Підключення клієнта](#connect-a-client) | [Бенчмарки](#доказ-на-цьому-репозиторії) | [Технічна специфікація](TECHNICAL_SPEC.md) | [Стратегія пам’яті](MEMORY_STRATEGY.md)
