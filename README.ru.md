...
Подключите в клиенте MCP-сервер `tqmemory` с командой `turbo-memory-mcp serve`.

Конфиги для разных клиентов: [CLIENT_INTEGRATIONS.ru.md](CLIENT_INTEGRATIONS.ru.md)
