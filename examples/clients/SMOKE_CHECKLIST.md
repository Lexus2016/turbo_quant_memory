...
| Method | Command |
|---|---|
| Primary | `uv tool install git+https://github.com/Lexus2016/turbo_quant_memory@v0.5.0` |
| Fallback | `python -m pip install git+https://github.com/Lexus2016/turbo_quant_memory@v0.5.0` |
