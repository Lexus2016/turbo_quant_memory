...
| Спосіб | Команда |
|---|---|
| Основний | `uv tool install git+https://github.com/Lexus2016/turbo_quant_memory@v0.6.0` |
| Резервний | `python -m pip install git+https://github.com/Lexus2016/turbo_quant_memory@v0.6.0` |
